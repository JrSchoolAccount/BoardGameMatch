    ...
    return (
        <div className="min-h-screen bg-gray-900 text-gray-100">
            <main>
                <section className="relative">
                    ...
                    <div className="relative z-10 container mx-auto px-4 py-16 sm:py-24 text-center">
                        ...
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-6 sm:mb-8 max-w-xl mx-auto text-gray-300">
                            Connect with board game enthusiasts, discover new
                            games, and never play alone again. Your next great
                            gaming experience is just a click away.
                        </p>
                ...
                <section
                    id="features"
                    className="bg-gray-800/50 py-12 sm:py-20"
                >
                    <div className="container mx-auto px-4">
                        <h2 className="text-2xl sm:text-3xl font-bold mb-8 sm:mb-12 text-center">
                            Why Choose BoardGameMatch?
                        </h2>
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                            <FeatureCard
                                icon={
                                    <Users className="h-10 w-10 sm:h-12 sm:w-12 text-teal-500" />
                                }
                            ...
                            <FeatureCard
                                icon={
                                    <Search className="h-10 w-10 sm:h-12 sm:w-12 text-teal-500" />
                                }
                            ...
                            <FeatureCard
                                icon={
                                    <Clock className="h-10 w-10 sm:h-12 sm:w-12 text-teal-500" />
                                }
                            ...
                            <FeatureCard
                                icon={
                                    <Zap className="h-10 w-10 sm:h-12 sm:w-12 text-teal-500" />
                                }
                ...
                <section className="container mx-auto px-4 py-12 sm:py-20 text-center">
                    ...
                    <p className="text-base sm:text-lg mb-6 sm:mb-8 text-gray-300">
                        Join thousands of board game lovers and start your
                        journey today!
                    </p>
            ...
            <footer className="bg-gray-800/50 py-6">
                <div className="container mx-auto px-4 text-center text-gray-400">
                    <p className="text-sm sm:text-base">
                        &copy; {new Date().getFullYear()} BoardGameMatch. All
                        rights reserved.
                    </p>
                </div>
            </footer>
